...
<img
  src="/static/images/tech-blog/td_algorithm.png"
  alt="td_algorithm"
...
<img
  src="/static/images/tech-blog/td_sarsa_algorithm.png"
  alt="td_sarsa_algorithm"
  className="mx-auto block w-3/4"
/>
...
Target을 계산할 때 사용되는 Term이 $$\gamma Q(s_{t+1}, a_{t+1})$$에서 $$\gamma \max_a Q(s_{t+1},a)$$로 바뀌었다. 이제는 $$s_t$$에서는 SARSA와 동일하게 $$\epsilon$$-Greedy Policy로 결정했지만 $$s_{t+1}$$에서는 항상 Q Value가 가장 클 때의 Action을 선택하고 있다. 이러한 점에서 Off-Policy라는 것이다.

<img
  src="/static/images/tech-blog/td_q_learning_algorithm.png"
  alt="td_q_learning_algorithm"
  className="mx-auto block w-3/4"
/>
