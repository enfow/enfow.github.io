...
$$
v_{k+1}^\pi(s) = \mathbb{E}_\pi \left[ r_{t+1} + \gamma v_k^\pi(s_{t+1}) \mid s_t = s \right] 
= \sum_a \pi(a \mid s) \sum_{s', r} p(s', r \mid s, a) \left[ r + \gamma v_k^\pi(s') \right]
$$
...
<img
src="/static/images/tech-blog/iterative_policy_evaluation_algorithm.png"
alt="iterative_policy_evaluation_algorithm"
...
<img
  src="/static/images/tech-blog/policy_iteration_algorithm.png"
  alt="policy_iteration_algorithm"
  className="mx-auto block w-3/4"
/>
...
<img
src="/static/images/tech-blog/dp_convergence.png"
alt="dp_convergence"
...
- 업데이트 Sequence $$s_{k}$$의 순서와 중복 여부는 무관하나 모든 $$s \in S$$가 하나 이상은 포함되어야 한다.
