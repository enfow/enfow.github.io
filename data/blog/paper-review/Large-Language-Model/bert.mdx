...
<img src="/static/images/paper-review/transformer-model-architecture.png" alt="transformer" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-1-architecture.png" className="w-[30%] mx-auto block" />
...
<img src="/static/images/paper-review/bert-diff-gpt-elmo-arch.png" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/bert-fused-nmt.png" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/bert-conll-2003-score.png" className="w-[50%] mx-auto block" />
...
<img src="/static/images/paper-review/bert-input-embedding.png" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/bert-4-fine-tuning-tasks.png" className="w-full mx-auto block" />

좌측의 두 Task 유형은 복수의 문장을, 우측의 두 Task 유형은 한 개의 문장을 입력으로 받는다. Downstream Task 들의 Benchmark 는 다음과 같다.

<img src="/static/images/paper-review/bert-benchmark.png" className="w-full mx-auto block" />
