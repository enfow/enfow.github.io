...
<img src="/static/images/paper-review/c51_fig1.png" className="w-[30em]" />
...
$$
Z_\theta (s, a) = z_i \quad \quad w.p. \ p_i(s,a) = { {e^{\theta_i (s,a)}} \over {\sum_j e^{\theta_j (s,a)}}}
$$
...
<img src="/static/images/paper-review/c51_algorithm.png" className="w-[25em]" />
