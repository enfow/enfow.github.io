...
<img
  src="/static/images/paper-review/planet_planning_algorithm.png"
  className="mx-auto my-4 block w-[42em]"
/>
...
& + \sum_{t=1}^T (E_{q(s_t \lvert o_{\leq t}, a_{< t})} [\log p(o_t \lvert s_t)])
\end{align}
\end{align}
$$
...
<img
  src="/static/images/paper-review/planet_recurrent_state_space_model.png"
  className="mx-auto my-4 block w-[42em]"
/>
...
$$
\begin{align}
\log p_d (o_{1:T}) \geq&  \sum_{t=1}^T (E_{q(s_t \lvert o_{\leq t})}[\log p(o_t \lvert s_t)])\\
...
<img
  src="/static/images/paper-review/planet_standard_variationa_bound_and_observation_overshooting.png"
  className="mx-auto my-4 block w-[32em]"
/>
...
$$
\begin{align}
{1 \over D} \sum_{d=1}^D \log p_d (o_{1:T}) =&  \sum_{t=1}^T (E_{q(s_t \lvert o_{\leq t})}[\log p(o_t \lvert s_t)])\\
&- {1 \over D} \sum_{d=1}^D \beta_d E_{p(s_{t-1} \lvert s_{t-d})q(s_{t-d} \lvert o_{\leq t-d})}[\text{D}_{\text{KL}}[q(s_t \lvert o_{\leq t}) \lvert \rvert p(s_t \lvert s_{t-1})]]
\end{align}
$$
...
<img
  src="/static/images/paper-review/planet_latent_overshooting.png"
  className="mx-auto my-4 block w-[24em]"
/>
...
<img src="/static/images/paper-review/planet_algorithm.png" className="mx-auto block w-[32em]" />
