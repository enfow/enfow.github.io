---
title: '[World Models] World Models'
date: '2020-09-08'
...
<img
  src="/static/images/paper-review/world_model_architecture.png"
  className="mx-auto block w-[33em]"
/>
...
<img src="/static/images/paper-review/world_model_m_model.png" className="mx-auto block w-[35em]" />
...
$$
p(y \lvert x) = \sum_{i=1}^n (c=i \lvert x) N(y; \mu_i, \sigma_i)
$$
...
<img src="/static/images/paper-review/world_model_process.png" className="mx-auto block w-[35em]" />
...
6. M Model은 V Model의 $$z_t$$, C Model의 $$a_t$$, 그리고 자기 자신의 $$h_t$$를 통해 다음 time step에 사용할 $$h_{t+1}$$을 만들어둔다.
...
<img src="/static/images/paper-review/world_model_rollout.png" className="mx-auto block w-[25em]" />
...
<img src="/static/images/paper-review/world_model_score.png" className="mx-auto block w-[15em]" />
