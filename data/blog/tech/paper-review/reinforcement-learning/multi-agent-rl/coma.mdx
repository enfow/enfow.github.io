...
$$g = E_{s_{0:\infty, u_{0:\infty}}}[\sum_{t=1}^{T} R_t \nabla_{\theta_\pi} \log \pi(u_t \lvert s_t)]$$
...
<img src="/static/images/study/coma_architecture.png" className="mx-auto block w-[45em]" />
...
&= Q(s, \boldsymbol{u}) - \sum_{u'^a} \pi^a ({u'}^a \lvert \tau^a) Q(s, ( \boldsymbol{u}^{-a}, {u'}^a)) \\
\end{align}
$$
...
<img src="/static/images/study/coma_critic.png" className="float-left w-[15em]" />
