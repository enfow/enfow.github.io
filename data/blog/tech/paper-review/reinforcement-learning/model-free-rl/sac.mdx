---
title: '[SAC] Off-Policy Maximum Entropy Deep Reinforcement Learning with a Stochastic Actor'
date: '2020-10-09'
...
$$
J(\pi) = \sum_t E_{(s_t, a_t) \backsim \rho_\pi} [r(s_t, a_t)]
$$
...
$$
J(\pi) = \sum_t E_{(s_t, a_t) \backsim \rho_\pi} [r(s_t, a_t) + \alpha \mathcal H (\pi( \cdot \lvert s_t) )]
$$
...
<img src="/static/images/paper-review/sac_algorithm.png" className="mx-auto block w-full" />
