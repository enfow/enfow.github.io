...
<img src="/static/images/paper-review/oac_fig1.png" className="mx-auto block w-full" />
...
$$
\sigma_Q(s,a) = \root \of {\sum_{i \in \{ 1,2 \} } {1 \over 2} ( Q_{LB}^i(s,a) - \mu_Q(s,a) )^2 } \\
...
<img src="/static/images/paper-review/oac_fig2.png" className="mx-auto block w-full" />
