...
<img
  src="/static/images/paper-review/harry-potter-llm-overview.png"
  alt="harry-potter-llm-overview"
...
<img
  src="/static/images/paper-review/harry-potter-affection-familiarity.png"
  alt="harry-potter-affection-familiarity"
...
<img
  src="/static/images/paper-review/harry-potter-llm-base-setting-prompt.png"
  alt="harry-potter-llm-base-setting-prompt"
  className="mx-auto block w-full"
/>

<img
  src="/static/images/paper-review/harry-potter-llm-rich-setting-prompt.png"
  alt="harry-potter-rich-setting-prompt"
  className="mx-auto block w-full"
/>
...
<img
  src="/static/images/paper-review/harry-potter-llm-exp-result.png"
  alt="harry-potter-llm-exp-result"
  className="mx-auto block w-full"
/>
...
<img
  src="/static/images/paper-review/harry-potter-llm-exp-result-2.png"
  alt="harry-potter-llm-exp-result-2"
  className="mx-auto block w-[60%]"
/>
...
<img
  src="/static/images/paper-review/harry-potter-llm-exp-result-3.png"
  alt="harry-potter-llm-exp-result-3"
  className="mx-auto block w-full"
/>
