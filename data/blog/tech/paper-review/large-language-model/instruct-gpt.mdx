...
<img
  src="/static/images/paper-review/instruct-gpt-3step-diagram.png"
...
<img
  src="/static/images/paper-review/instruct-gpt-win-rate-sft-175.png"
  alt="instruct-gpt-win-rate-sft-175"
...
<img
  src="/static/images/paper-review/instruct-gpt-metadata-result.png"
  alt="instruct-gpt-metadata-result"
  className="mx-auto block w-full"
/>
...
<img
  src="/static/images/paper-review/instruct-gpt-truthfulqa-result.png"
  alt="instruct-gpt-truthfulqa-result"
  className="mx-auto block w-full"
/>
...
<img
  src="/static/images/paper-review/instruct-gpt-toxicity-result.png"
  alt="instruct-gpt-toxicity-result"
  className="mx-auto block w-full"
/>
...
<img
  src="/static/images/paper-review/instruct-gpt-rlhf-nlp-dataset-result.png"
  alt="instruct-gpt-rlhf-nlp-dataset-result"
  className="mx-auto block w-full"
/>
