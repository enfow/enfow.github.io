...
$$
X_{l+1} = \sigma ( \tilde D^{-\frac{1}{2}} \tilde A \tilde D^{-\frac{1}{2}} X_l W_l )
$$
...
<img
  src="/static/images/paper-review/learnable_graph_convolution_layer.png"
  className="mx-auto block w-[42em]"
/>
...
<img
  src="/static/images/paper-review/learnable_graph_convolution_network.png"
  className="mx-auto block w-[42em]"
/>
...
<img
  src="/static/images/paper-review/lgcn_sub_graph_selection_algorithm.png"
...
<img
  src="/static/images/paper-review/lgcn_sub_graph_bfs_example.png"
  className="mx-auto block w-[32em]"
/>
