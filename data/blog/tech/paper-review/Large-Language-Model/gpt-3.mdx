...
<img src="/static/images/paper-review/gpt-3-in-context-learning-pretraining.png" alt="gpt-3-in-context-learning.png" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-shots.png" alt="gpt-3-shots" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-trained-models.png" alt="gpt-3-model-size-and-n-of-examples" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-training-loss.png" alt="gpt-3-model-size-and-n-of-examples" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-aggregated-in-context-performance.png" alt="gpt-3-aggregated-in-context-performance" className="w-full mx-auto block" />

또한 아래 Plot 에서는 모델의 크기와 In-Context Learning 의 상관 관계를 보여주고 있다.

<img src="/static/images/paper-review/gpt-3-model-size-and-n-of-examples.png" alt="gpt-3-model-size-and-n-of-examples" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-lambada-example.png" alt="gpt-3-lambada" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-storycloze-example.png" alt="gpt-3-storycloze-example" className="w-full mx-auto block" />

HellaSwag 도 StoryCloze 와 유사한데, 4지선다 문제라는 점에서 차이가 있다.

<img src="/static/images/paper-review/gpt-3-hallaswag-example.png" alt="gpt-3-hallaswag-example" className="w-[80%] mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-cloze-and-completion-task-performance.png" alt="gpt-3-cloze-and-completion-task-performance" className="w-full mx-auto block" />
...
<img src="/static/images/paper-review/gpt-3-closed-book-qa-task-performance.png" alt="gpt-3-cloze-and-completion-task-performance" className="w-full mx-auto block" />
