...
date: '2020-03-28'
tags: ['Generative-Model', 'Auto-Encoder']
draft: false
summary: ''
---
...
<img src="/static/images/paper-review/vae.png" className="w-[30em]" />
...
여기서 $$L(\theta, \phi ; x)$$를 **lower bound**라고 하는데, 이는 우변의 두 번째 항 $$ D*{KL}(q*{\phi}(z \lvert x) \| p\_\theta(z \lvert x))$$이 항상 양수이기 때문에 다음과 같이 표현할 수 있어 붙은 이름이다.
