...
$$
\text{RMSE}(w) = \sqrt { \sum_{s \in \mathcal S} d(s) [v_\pi(s) - \hat v (s, w)]^2 }
$$
...
$$
\sum_{k=1}^\infty \alpha_k(a) = \infty \qquad \text{and} \qquad \sum_{1}^\infty \alpha^2_k(a) < \infty
$$
...
<img
  src="/static/images/tech-blog/on_policy_approx_coarse_coding.png"
  alt="on_policy_approx_coarse_coding"
...
<img
  src="/static/images/tech-blog/on_policy_approx_result_of_coarse_coding.png"
  alt="on_policy_approx_result_of_coarse_coding"
  className="mx-auto block w-3/4"
/>
...
<img
  src="/static/images/tech-blog/on_policy_approx_coarse_coding_narrow.png"
  alt="on_policy_approx_coarse_coding_narrow"
  className="mx-auto block w-3/4"
/>

<img
  src="/static/images/tech-blog/on_policy_approx_coarse_coding_wide.png"
  alt="on_policy_approx_coarse_coding_wide"
  className="mx-auto block w-3/4"
/>
...
<img
  src="/static/images/tech-blog/on_policy_approx_size_and_shape.png"
  alt="on_policy_approx_size_and_shape"
  className="mx-auto block w-3/4"
/>
